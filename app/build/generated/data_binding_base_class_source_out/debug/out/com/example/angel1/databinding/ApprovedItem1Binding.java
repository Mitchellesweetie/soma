...
public final class ApprovedItem1Binding implements ViewBinding {
  @NonNull
  ...
  private ApprovedItem1Binding(@NonNull CardView rootView, @NonNull ImageView imageView3,
  ...
  @NonNull
  public static ApprovedItem1Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ApprovedItem1Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.approved_item1, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ApprovedItem1Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ApprovedItem1Binding((CardView) rootView, imageView3, lottieAnimationView,
