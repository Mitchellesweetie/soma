...
public final class ApplicationShimerBinding implements ViewBinding {
  @NonNull
  ...
  private ApplicationShimerBinding(@NonNull CardView rootView,
      @NonNull AppCompatButton appCompatButton, @NonNull ImageView imageView3,
  ...
  @NonNull
  public static ApplicationShimerBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ApplicationShimerBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.application_shimer, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ApplicationShimerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ApplicationShimerBinding((CardView) rootView, appCompatButton, imageView3,
