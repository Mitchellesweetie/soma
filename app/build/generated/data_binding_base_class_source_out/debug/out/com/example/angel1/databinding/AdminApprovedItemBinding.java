...
public final class AdminApprovedItemBinding implements ViewBinding {
  @NonNull
  ...
  private AdminApprovedItemBinding(@NonNull CardView rootView,
      @NonNull AppCompatButton appCompatButton3, @NonNull TextView imageView3,
  ...
  @NonNull
  public static AdminApprovedItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AdminApprovedItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.admin_approved_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AdminApprovedItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AdminApprovedItemBinding((CardView) rootView, appCompatButton3, imageView3,
