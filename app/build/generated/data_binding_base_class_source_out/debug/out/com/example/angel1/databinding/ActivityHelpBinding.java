...
public final class ActivityHelpBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView www;

  private ActivityHelpBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView5,
      @NonNull ImageView imageView6, @NonNull ImageView imageView7, @NonNull ImageView imageView8,
      @NonNull TextView textView16, @NonNull TextView textView25, @NonNull ImageView www) {
  ...
  public static ActivityHelpBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.www;
      ImageView www = ViewBindings.findChildViewById(rootView, id);
      if (www == null) {
        break missingId;
      }

      return new ActivityHelpBinding((ConstraintLayout) rootView, imageView5, imageView6,
          imageView7, imageView8, textView16, textView25, www);
    }
